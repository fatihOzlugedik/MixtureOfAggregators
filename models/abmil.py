...
class ABMIL(BaseAggregator):
    def __init__(self, input_dim=None, size_arg = "big", n_heads=1, dropout=0.1, num_classes=4):
        r"""
        Attention MIL Implementation
    ...
    def forward(self, x, *args):
        ...
        latent = h_path # [512] vector
        
        logits  = self.classifier(latent).unsqueeze(0) # logits needs to be a [1 x 4] vector 
